...
class DMS
{
    ...
    {
        add_options_page('Domain Mapping System Options', 'DMS Options', 'administrator', 'dms-options', array(
            'DMS',
            'includeTemplate'
        ));
    }
    ...
    private function registerSettings()
    {
        ...
        register_setting('dms_storage', 'dms_map');
    ...
    {
        wp_register_script('dms-js', plugins_url('dms.js', __FILE__), array(
            'jquery'
        ));
        wp_register_script('chosen-js', plugins_url('chosen.jquery.js', __FILE__), array(
            'jquery'
        ));
